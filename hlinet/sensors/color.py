...
class ColorRegionSensor:
    def extract(self, image: np.ndarray) -> list[Atom]:
        ...
        color_ranges = {
            ...
            "orange": [(10, 70, 80), (20, 255, 255)],
            "golden": [(20, 30, 80), (35, 255, 255)],
            "yellow": [(35, 60, 80), (70, 255, 255)],
            "green": [(70, 60, 60), (90, 255, 255)],
            "blue": [(90, 60, 60), (130, 255, 255)],
            "purple": [(130, 60, 60), (170, 255, 255)],
            "white": [(0, 0, 180), (180, 40, 255)],
            "black": [(0, 0, 0), (180, 255, 50)],
            "brown": [(5, 50, 40), (20, 200, 180)],
        }
