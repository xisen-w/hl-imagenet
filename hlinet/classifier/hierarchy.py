            ...
            ClassNode(
                ...
                children=[
                    ClassNode(
                        name="zebra",
                        is_leaf=True,
                        required_features=["striped_texture"],
                        supporting_features=["black_white_dominant", "quadruped_like", "green_context"],
                    ...
                    ClassNode(
                        ...
                        supporting_features=["quadruped_like", "fur_texture", "organic_texture", "green_context"],
                        excluding_features=["striped_texture", "wheel_like", "keyboard_pattern", "smooth_texture"],
                    ),
                    ClassNode(
                        name="eagle",
                        is_leaf=True,
            ...
            ClassNode(
                ...
                children=[
                    ClassNode(
                        ...
                        supporting_features=["rectangular_shape", "wheel_like", "vehicle_like", "smooth_texture"],
            ...
            ClassNode(
                ...
                children=[
                    ClassNode(
                        ...
                        excluding_features=["wheel_like", "keyboard_pattern", "yellow_dominant", "striped_texture"],
                    ),
                    ClassNode(
                        name="banana",
                        is_leaf=True,
            ...
            ClassNode(
                ...
                children=[
                    ClassNode(
                        name="laptop",
                        is_leaf=True,
                        required_features=["screen_rectangle"],
                        supporting_features=["keyboard_pattern", "rectangular_shape", "smooth_texture"],
            ...
            ClassNode(
                ...
                children=[
                    ClassNode(
                        name="piano",
                        is_leaf=True,
                        required_features=["keyboard_pattern"],
                        supporting_features=["black_white_dominant", "rectangular_shape", "smooth_texture"],
                        excluding_features=["screen_rectangle", "fur_texture", "golden_brown_color"],
                    ),
                ],
            ),
            ClassNode(
                ...
                children=[
                    ClassNode(
                        ...
                        is_leaf=True,
                        required_features=["organic_texture"],
                        supporting_features=["handle_spout", "circular_components", "smooth_texture"],
                        excluding_features=["wheel_like", "fur_texture", "keyboard_pattern", "yellow_dominant", "striped_texture", "green_context"],
                    ),
                ],
            ),
        ],
